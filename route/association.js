...
router.use('/user',function(req,res){
    ...
    if(req.query.judge==2) user.findAll(req,res);
...
router.use('/team',function(req,res){
    ...
    if(req.query.judge==2) team.findAll(req,res);
...
router.use('/day',function(req,res){
    res.setHeader("Access-Control-Allow-Origin", "*");
    if(req.query.judge==0) day.findAll(req,res);
    if(req.query.judge==1) day.findById(req,res);
})
router.use('/consume',function(req,res){
    res.setHeader("Access-Control-Allow-Origin", "*");
    if(req.query.judge==0) consume.findAll(req,res);
...
router.use('/statistic_module',function(req,res){
    ...
    if(req.query.judge==3) statistic_module.findAll(req,res);
})
